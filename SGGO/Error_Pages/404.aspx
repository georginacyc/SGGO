<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="SGGO.Error_Pages._400" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="card" style="width: 70%; height: 40%; margin: 10px auto auto auto; padding: 20px; vertical-align: middle;">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="40px" Text="Oops! We can't find what you're looking for."></asp:Label>
                <br />
