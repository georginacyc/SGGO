    ...
    public partial class Create_User_Account : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateInput() == true)
            {
                ...
                int result = client.CreateAccount(email, pwhash, pwsalt, "User", fname, lname, DateTime.Now, "90098008", "711111", "Blk 123 NYP", "/Images/Profile_Pictures/default.jpg", null, null );
