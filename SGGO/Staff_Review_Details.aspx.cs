                ...
                else
                {
                    if (Session["Role"].ToString() == "Staff")
                    {
                        ...
                        if (!String.IsNullOrEmpty(Request.QueryString["id"]))
                        {
                            ...
                            gem_lb.Text = "<a style='color: black; text-decoration: underline;' target='_blank' href='Gem_Listing.aspx?gemId=" + review.Post + "'>" + gem.Title + "</a>"; // now is id, will need to retrieve name with it next time. also want to make it clickable, link to gem page.
