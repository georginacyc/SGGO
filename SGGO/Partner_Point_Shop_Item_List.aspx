<%@ Page Title="" Language="C#" MasterPageFile="~/Partner.Master" AutoEventWireup="true" CodeBehind="Partner_Point_Shop_Item_List.aspx.cs" Inherits="SGGO.Partner_Point_Shop_Item_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btn_GotoCreateItem" runat="server" OnClick="btn_GotoCreateItem_Click" Text="Create Point Shop Item" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
    ...
    <asp:SqlDataSource ID="MyPSIDS" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\SGGO_DB.mdf;Integrated Security=True;Connect Timeout=30" ProviderName="System.Data.SqlClient" 
        SelectCommand="SELECT [point_shop_item_id], [name], [price], [type]  FROM [Point_Shop_Item] WHERE ([partner] = @partner)">
        <SelectParameters>
